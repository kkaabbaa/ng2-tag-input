...
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_21__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TagInputComponent = (function (_super) {
	    ...
	    TagInputComponent.prototype.setInputValue = function (value, isTransform) {
	        if (isTransform === void 0) { isTransform = true; }
	        var item = value && isTransform ? this.transform(value) : value;
...
/***/ function(module, exports) {
	...
	function onAutocompleteItemClicked(item) {
	    ...
	    this.setInputValue(string, false);
	    this.focus();
	    this.dropdown.hide();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".flex, .tag-input, .tag {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex; }\n\n.tag-input {\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: row;\n          flex-direction: row;\n  -ms-flex-wrap: wrap;\n      flex-wrap: wrap;\n  -webkit-transition: all 0.15s;\n  transition: all 0.15s;\n  padding: 0.25rem 0.2rem;\n  min-height: 32px;\n  cursor: text; }\n\n.tag-input:focus {\n  outline: 0; }\n\n.tags-container {\n  -ms-flex-wrap: wrap;\n      flex-wrap: wrap; }\n\n.tag-input form {\n  margin: 0.1em 0; }\n\n.tag-input__text-input {\n  border: none;\n  display: inline;\n  padding: 0 0.5rem;\n  vertical-align: middle;\n  font-size: 15px;\n  height: 35px;\n  font-family: \"Roboto\", \"Helvetica Neue\", sans-serif; }\n\n.tag-input__text-input:focus {\n  outline: 0; }\n\n.tag--readonly {\n  cursor: default; }\n\n.tag--readonly:focus, .tag {\n  outline: 0; }\n\n.tag {\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: row;\n          flex-direction: row;\n  -ms-flex-wrap: wrap;\n      flex-wrap: wrap;\n  font-family: \"Roboto\", \"Helvetica Neue\", sans-serif;\n  font-weight: 400;\n  font-size: 15px;\n  letter-spacing: 0.05rem;\n  color: #222;\n  cursor: pointer;\n  border-radius: 16px;\n  -webkit-transition: all 0.25s;\n  transition: all 0.25s;\n  margin: 0.1rem 0.2rem;\n  padding: 0.08rem 0.5rem;\n  height: 32px;\n  line-height: 32px; }\n\n.tag__remove-button {\n  margin-left: 6px;\n  width: 16px;\n  height: 26px;\n  -ms-flex-item-align: center;\n      -ms-grid-row-align: center;\n      align-self: center;\n  -webkit-transition: all 0.15s;\n  transition: all 0.15s; }\n\n.tag__remove-button:hover {\n  -webkit-transform: scale(1.3);\n          transform: scale(1.3); }\n\n.tag-input__errors-container {\n  margin: 0.5em 0; }\n\n.tag-input__error-message {\n  font-size: 12px;\n  color: #f44336; }\n\n.default.tag-input--invalid, .minimal.tag-input--invalid, .dark.tag-input--invalid {\n  border-bottom: 2px solid #f44336; }\n\n.tag-input.default {\n  border-bottom: 2px solid #efefef; }\n\n.default.tag-input--focused {\n  border-bottom: 2px solid #2196F3; }\n\n.default .tag {\n  background: #efefef; }\n\n.default .tag:not(.tag--readonly):focus {\n  background: #2196F3;\n  color: #fff; }\n\n.default .tag:not(:focus):not(.tag--readonly):hover {\n  background: #e6e6e6; }\n\n.default .tag:focus path {\n  fill: #fff; }\n\n.tag-input.minimal {\n  border-bottom: 1px solid transparent; }\n\n.minimal .tag {\n  background: #f9f9f9;\n  border-radius: 0; }\n\n.minimal .tag:not(.tag--readonly):focus {\n  background: #ddd; }\n\n.minimal .tag:not(:focus):not(.tag--readonly):hover {\n  background: #f0f0f0; }\n\n.minimal .tag:not(:focus):not(.tag--readonly):hover {\n  background: #f0f0f0; }\n\n.tag-input.dark {\n  border-bottom: 2px solid #212121; }\n\n.dark .tag {\n  background: #212121;\n  color: #f9f9f9; }\n\n.dark .tag:not(.tag--readonly):focus {\n  background: #999;\n  color: #212121; }\n\n.dark path {\n  fill: #fff; }\n", ""]);
